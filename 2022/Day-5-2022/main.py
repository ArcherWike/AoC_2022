...
#SupplyStacks = [['S','L','W'],['J','T','N','Q',],['S','C','H','F','J',],['T','R','M','W','N','G','B',],['T','R','L','S','D','H','Q','B',],['M','J','B','V','F','H','R','L',],['D','W','R','N','J','M',],['B','Z','T','F','H','N','D','J',],['H','L','Q','N','B','F','T',]]
SupplyStacks = []
